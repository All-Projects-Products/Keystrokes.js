...
function App() {
    ...
    return (
        <>
            {/* Mobile Block Screen */}
            <div className="min-h-screen bg-slate-900 text-white p-10 font-mono flex sm:hidden flex-col items-center justify-center text-center">
                <h1 className="text-2xl font-bold text-emerald-400 mb-4">Screen Too Small</h1>
                <p className="text-slate-400 leading-relaxed">
                    Kindly open it on your laptop to test your speed or learn typing lesson.
                </p>
            </div>

            {/* Desktop App */}
            <div className="min-h-screen bg-slate-900 text-white p-10 font-mono hidden sm:flex flex-col items-center justify-center selection:bg-emerald-500/30 overflow-x-hidden">
                <ResultsModal
                    isOpen={isFinished}
                ...
                {/* Header / Nav */}
                <div className="absolute top-16 w-full max-w-4xl flex justify-between items-end border-b border-slate-800 pb-4 px-10 min-[970px]:px-0">
                    <div>
                ...
                <div className="mt-32 w-full flex flex-col items-center gap-8">
                    ...
                    {/* Heatmap & Hands */}
                    <div className="flex flex-col lg:flex-row gap-8 items-start w-full max-w-4xl mt-8">
